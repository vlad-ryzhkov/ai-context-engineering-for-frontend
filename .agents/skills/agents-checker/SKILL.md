---
name: agents-checker
description: Verify .claude/agents/ structural integrity
---
...
2. Second, read the specific skill protocol: `.claude/skills/agents-checker/SKILL.md`
3. Execute based STRICTLY on the logic and output format defined in those files.

## CRITICAL REMINDERS

- Checks compliance with init-agent standards
- Read-only analysis
