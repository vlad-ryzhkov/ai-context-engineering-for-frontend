---
name: browser-check
description: AI self-verification of running UI via agent-browser
---
...
2. Second, read the specific skill protocol: `.claude/skills/browser-check/SKILL.md`
3. Execute based STRICTLY on the logic and output format defined in those files.

## CRITICAL REMINDERS

- No file artifacts — chat-only output
