...
description: Sync docs/ai-setup.md Registry with current project state
---
...
2. Second, read the specific skill protocol: `.claude/skills/update-ai-setup/SKILL.md`
3. Execute based STRICTLY on the logic and output format defined in those files.

## CRITICAL REMINDERS

- Scans all AI files automatically
- Do NOT use to create Registry from scratch
